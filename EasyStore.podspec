...
Pod::Spec.new do |s|
  s.name             = 'EasyStore'
  s.version          = '0.1.0'
  s.summary          = 'A short description of EasyStore.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Akira/EasyStore'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Akira' => 'akira.matsuda@me.com' }
  s.source           = { :git => 'https://github.com/Akira/EasyStore.git', :tag => s.version.to_s }
